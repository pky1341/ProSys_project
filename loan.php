...
<body>
  <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
      <div class="relative px-4 py-10 bgRed mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        ...
        <div class="max-w-md mx-auto text-white">
          <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label class="font-semibold text-sm text-gray-400 pb-1 block" for="memberId">MemberShip
                Id</label>
              <input
                class="border borderColor rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bgRed text-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
          ...
          <div class="mt-5">
            <button
              class="py-2 px-4 bgbtn hover:bgbtn focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
              type="submit">
              Submit
            </button>
          </div>
